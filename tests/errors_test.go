...
func TestNew(t *testing.T) {
	tests := []struct {
		...
		{"foo", fmt.Errorf("foo")},
		{"foo", New("foo")},
		{"string with format specifiers: %v", NewPlain("string with format specifiers: %v")},
	}
...
// NewPlain, etc values are not expected to be compared by value

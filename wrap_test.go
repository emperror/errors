...
func TestUnwrap(t *testing.T) {
	...
	testCases := []struct {
		...
		{wrappedCauser{"wrapped", nil}, nil},
		{err1, nil},
		{erra, err1},
		{wrapped{"wrap 3", erra}, erra},
		{wrappedCauser{"wrap 3", erra}, erra},
	}
	for _, tc := range testCases {
...
type wrappedCauser struct {
	msg string
	err error
}

func (e wrappedCauser) Error() string { return e.msg }

func (e wrappedCauser) Cause() error { return e.err }
